...
cLink.pack(fill="x")
lblLink = Label(cLink, text=YT.title, font="Arial, " + (str) ((int) ((wWidth/30))), bg="seagreen1").grid()
...
lblCreditos = Label(cCreditos, text="Jeffry Samuel Eduarte Rojas | Tentri#5008", font="Arial, " + (str) ((int) ((wWidth/30))), fg="snow", bg="grey20").pack(anchor="center")
win.mainloop()
