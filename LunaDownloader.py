...
cTitulo.pack(fill="x")
lblTitulo = Label(cTitulo, text="Luna Downloader", font="Arial, " + (str) ((int) ((wWidth*14/200))), bg="lightblue").pack(anchor="center")

cLink = Canvas(win, bg="seagreen1", highlightthickness=0)
cLink.pack(fill="x")
lblLink = Label(cLink, text=YT.title, font="Arial, " + (str) ((int) ((wWidth*7/200))), bg="seagreen1").grid()
...
lblCreditos = Label(cCreditos, text="Jeffry Samuel Eduarte Rojas | Tentri#5008", font="Arial, " + (str) ((int) ((wWidth*7/200))), fg="snow", bg="grey20").pack(anchor="center")
win.mainloop()
